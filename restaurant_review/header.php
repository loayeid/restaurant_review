        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.php?page=add-restaurant">Add Restaurant</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="index.php?page=add-review">Add Review</a></li>
